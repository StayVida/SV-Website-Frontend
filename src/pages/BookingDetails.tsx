...
import { Loader2, ArrowLeft, CheckCircle, Clock, Star, Send, MessageSquare, Download } from "lucide-react";
...
export default function BookingDetails() {
  ...
  usePageSEO({
    ...
    description: "View your StayVida booking details, payment summary, and property information.",
  });
  ...
  const handleDownloadPDF = async () => {
    ...
    try {
      ...
      const canvas = await html2canvas(element, {
        ...
        onclone: (clonedDoc) => {
          ...
          for (let i = 0; i < elements.length; i++) {
            ...
            // Fix for oklch in common properties
            ...
            props.forEach(prop => {
              ...
              if (val && val.includes("oklch")) {
                // Replace with a neutral fallback if oklch is detected
                if (prop === "color") el.style.color = "#171717";
                else if (prop === "backgroundColor") {
                  if (el.classList.contains("bg-primary")) el.style.backgroundColor = "#00ab5b";
                  else el.style.backgroundColor = "transparent";
                }
                else el.style.borderColor = "#e5e5e5";
              }
            });
          }
        }
      ...
      pdf.save(`StayVida-Booking-${data.booking_ID}.pdf`);
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-8">
      ...
      <Card className="md:col-span-2 border-primary/20 bg-primary/5 mt-8">
        <CardHeader>
