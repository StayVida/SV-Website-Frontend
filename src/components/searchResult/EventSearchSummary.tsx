import { Calendar, Users, Baby, MapPin } from "lucide-react";
...
function EventSearchSummary({ searchData }: { searchData: SearchData }) {
  return (
        ...
        <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between">
          <div>
            <h1 className="text-2xl font-bold text-gray-900 mb-2">
              Event Venues in {searchData.destination}
            </h1>
            <div className="flex items-center space-x-6 text-gray-600">
              ...
              <div className="flex items-center">
                ...
                {Number(searchData.children) > 0 && (
                  <>
                    , <Baby className="w-4 h-4 mx-1" />
                    <span>{searchData.children} children</span>
                  </>
                )}
              </div>
            </div>
