...
function Footer() {
  return (
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-8">
        ...
        <div>
          ...
          <div className="space-y-2">
            <p className="text-green-100">Opp. Siddhu's Event's,</p>
            <p className="text-green-100">Mahalakshwar,</p>
            <p className="text-green-100">Maharashtra 412806</p>
            <p className="text-green-100">+91 094057 58183</p>
            <p className="text-green-100">info@stayvida.com</p>
          </div>
        </div>
      ...
      <div className="border-t border-green-800 mt-8 lg:mt-12 pt-6 lg:pt-8">
        <p className="text-center text-green-100 text-sm">© 2024 StayVida. All rights reserved.</p>
      </div>
    </div>
  </footer>
  )
